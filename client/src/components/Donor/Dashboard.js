    ...
    setDonationHistory((prevDonationHistory) => {
      ...
      if (existingOrg) {
        ...
        return prevDonationHistory.map((org) =>
          org.id === orgId
            ? { ...org, donationCount: org.donationCount + 1 }
            : org
        );
      } else {
  ...
  function handleHistoryClick() {
    ...
    orgIds.forEach(async (orgId) => {
      try {
        ...
        console.error(
          `Failed to fetch organization details for ID ${orgId}:`,
          error
        );
      }
    });
                ...
                <div className="md:pl-80 ">
                  <div className=" flex-grow flex flex-col py-16  mr-5 overflow-y-auto">
                    ...
                    <div>
                      ...
                      {selectedContent === "history" && !isWelcomeShown && (
                        <HistoryModal setIsWelcomeShown={setIsWelcomeShown} />
                      )}
                    </div>
                    ...
                    <div className="reminder-container">
                      ...
                      {selectedContent === "reminder" && !isWelcomeShown && (
                        <ReminderModal setIsWelcomeShown={setIsWelcomeShown} />
                      )}
                    </div>
                    ...
                    <div>
                      <>
                        {selectedContent === "my-transactions" && (
                          <TransactionHistory />
                        )}
                      </>
