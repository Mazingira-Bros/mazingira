  ...
  const handleLogout = () => {
    fetch("http://localhost:3000/logout", {
      ...
      .then((response) => {
        ...
        message.error("logged out succefully"); // "Session destroyed"
        navigate("/login");
      })
      .catch((error) => {
        console.error(error);
                      ...
                      <div className="flex flex-col h-full p-4  bg-[#000000]">
                        ...
                        <div className="flex flex-col h-full p-4">
                          ...
                          <button
                            className="py-2 mb-2 bg-[#fff5e1] hover:bg-yellow-200 text-[#32594a] text-gray-600 font-medium rounded-md mb-4 flex items-center justify-center"
                            onClick={() =>
                              setSelectedContent("content-management")
                            }
                          >
                          ...
                          <button
                            className="py-2 mb-2 bg-[#fff5e1] hover:bg-yellow-200 text-[#32594a] text-gray-600 font-medium rounded-md mb-4 flex items-center justify-center"
                            onClick={() =>
                              setSelectedContent("donor-management")
                            }
                          >
                          ...
                          <button
                            className="py-2 mb-2 bg-[#fff5e1] hover:bg-yellow-200 text-[#32594a] text-gray-600 font-medium rounded-md mb-4 flex items-center justify-center"
                            onClick={() =>
                              setSelectedContent("user-management")
                            }
                          >
                ...
                <div className="md:pl-80">
                  <div className=" flex-grow flex flex-col  py-20  mr-5 overflow-y-auto">
                    ...
                    <div>
                      ...
                      {selectedContent === "analytics" && !isWelcomeShown && (
                        <AnalyticsModal setIsWelcomeShown={setIsWelcomeShown} />
                      )}
                    </div>
                    ...
                    <div>
                      {/* Render MyDonations component for each organization and pass the props */}
                      {selectedContent === "content-management" && (
                        <ContentManagement />
                      )}
                      {/* Render MyDonationsModal with welcome message */}
                      {selectedContent === "content-management" &&
                    ...
                    <div>
                      {/* Render MyDonations component for each organization and pass the props */}
                      {selectedContent === "donor-management" && (
                        <DonorManagement />
                      )}
                      {/* Render MyDonationsModal with welcome message */}
                      {selectedContent === "donor-management" &&
                    ...
                    <div>
                      ...
                      {selectedContent === "support" && !isWelcomeShown && (
                        <SupportModal setIsWelcomeShown={setIsWelcomeShown} />
                      )}
                    </div>
                    ...
                    <div>
                      {selectedContent === "account-settings" && (
                        <AccountSettings />
                      )}
                    </div>
