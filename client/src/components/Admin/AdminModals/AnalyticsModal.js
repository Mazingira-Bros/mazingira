...
function AnalyticsModal({ setIsWelcomeShown }) {
     ...
     {isModalOpen && (
      <div className= "fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50 pointer-events-none">
        <div className="bg-white rounded-lg p-8 max-w-md pointer-events-auto">
          ...
          <p className="text-gray-600 mb-4">You should have access to analytics and reporting tools that help track the performance of the app, including user engagement, donation activity, and other key metrics.</p>
          <button
